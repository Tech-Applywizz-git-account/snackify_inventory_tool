        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Users currently subscribed to receive the daily report.
                </p>
              </div>
              <button
                type="button"
                aria-label="Close added report users"
            ...
            {users.filter((user) => user.consumer_report).length === 0 ? (
              <div className="rounded-xl border border-slate-100 bg-slate-50 p-5 text-center text-sm text-slate-500">
                No report recipients have been added yet.
              </div>
            ) : (
              <div className="overflow-x-auto rounded-xl border border-slate-200">
                <table className="min-w-full text-sm">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {users
                      .filter((user) => user.consumer_report)
                      .map((user) => (
                        <tr key={user.id}>
